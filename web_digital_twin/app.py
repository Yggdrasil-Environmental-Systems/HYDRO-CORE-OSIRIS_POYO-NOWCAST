    ...
    st.markdown(
        ...
        <div class='evac-banner-red'>
            <div style='display:flex; align-items:center; gap:16px;'>
                ...
                <div>
                    <div style='color:#ffffff; font-weight:800; font-size:1.10rem;'>ORDEN TÁCTICA SIMULADA — EVACUACIÓN VERTICAL PREVENTIVA (C4ISR / 112)</div>
...
with tab_esalert:
    ...
    with col_es2:
        ...
        with btn_c2:
            ...
            """
            st.download_button("📄 Exportar Informe Interactivo (Imprimible PDF)", html_informe, "informe_operativo_c4isr_wehd2026.html", "text/html", width="stretch")
        ...
        if "Nowcast" in sim_mode and alert_state == "ROJO":
            if rain_val > lluvia_sensor or medidas_manuales_activas:
                ...
                if not st.session_state.get("correo_rojo_enviado", False):
                    ...
                    st.info("ℹ️ Protocolo activado: Despacho simulado de alerta transmitido al Centro de Coordinación.")
...
# ------------------------------------------------------------------------------
with tab_compare:
    st.subheader("Auditoría Forense Split A/B: Inteligencia Anticipada vs. Protocolo Convencional")
    ...
    timeline_df = pd.DataFrame([
        ...
        dict(Task="Canal Masivo Convencional (20:11 h)", Start=t_alert_oficial, Finish=t_alert_oficial + timedelta(minutes=8), Tipo="Emisión Institucional de Referencia"),
    ])
